...
#6 transferring context: 13.59kB 0.1s done
#6 DONE 0.1s

#7 [builder 6/8] COPY server/tsconfig.json ./
#7 CACHED

#8 [builder 2/8] WORKDIR /app
#8 CACHED

#9 [builder 4/8] RUN npm ci
#9 CACHED

#10 [stage-1  3/11] RUN apt-get update && apt-get install -y --no-install-recommends openssl && rm -rf /var/lib/apt/lists/*
#10 CACHED

#11 [builder 3/8] COPY server/package*.json ./
#11 CACHED

#12 [stage-1  7/11] COPY --from=builder /app/dist ./dist
#12 CACHED

#13 [stage-1 10/11] RUN mkdir -p /app/certs
#13 CACHED

#14 [builder 8/8] RUN npm run build
#14 CACHED

#15 [builder 7/8] COPY server/scripts ./scripts
#15 CACHED

#16 [stage-1  4/11] COPY server/package*.json ./
#16 CACHED

#17 [stage-1  9/11] COPY server/healthcheck.js ./healthcheck.js
#17 CACHED

#18 [stage-1  8/11] COPY --from=builder /app/dist/schemas ./dist/schemas
#18 CACHED

#19 [stage-1  6/11] RUN npm ci --omit=dev
#19 CACHED

#20 [stage-1  5/11] COPY server/scripts ./scripts
#20 CACHED

#21 [builder 5/8] COPY server/src ./src
#21 CACHED
